...
|---|---:|
| 待機，沒有待製數量 | 36,000 |
| 運轉，仍有待製數量 | 576,000（總值，不另加待機） |

停電暫停兌換，恢復供電後繼續。完成或取消訂單回到待機耗電。

作者回報：滿工作速度、滿發電適應性帕魯搭配大型發電機也僅勉強支撐。測試基地另有 20 座各 3,000／秒的油田、帕魯資源工廠兩台設備及其他原版建築。這是整個基地的負載觀察，不代表任何單機供電保證。帕魯吃飯或離開崗位時，儲備電力可能快速下降。
